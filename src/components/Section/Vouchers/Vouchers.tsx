...
const Voucher = () => {
    return (
        <section className="vouchers w-svw" style={{backgroundImage: `url("${basePath}/images/basilico/voucher.jpg")`}}>
            <div className="container max-w-6xl">
                <div className="vouchers-content">
                    <div className="item image aos-init" data-aos-duration="1000" data-aos="fade-right">
                        <Image src={`${basePath}/images/basilico/menu2.jpg`} alt="" width={585} height={464} className='object-cover h-full'/>
                    </div>
                    <div className="item content">
                        <Image src={`${basePath}/images/basilico/shopping-bag.png`} alt="" data-aos-duration="1000" data-aos="fade-up" className="aos-init mx-auto" width={60} height={72}/>
                    ...
                    <div className="item content">
                        <Image src={`${basePath}/images/basilico/gift-card.png`} alt="" data-aos-duration="1000" data-aos="fade-up" className="aos-init mx-auto" width={71} height={71}/>
                    ...
                    <div className="item image aos-init" data-aos-duration="1000" data-aos="fade-left">
                        <Image src={`${basePath}/images/basilico/menu3.jpg`} alt="" width={585} height={464} className='h-full object-cover'/>
                    </div>
                </div>
            </div>
        </section>
